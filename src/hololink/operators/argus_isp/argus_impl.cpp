...
void ArgusImpl::set_reprocess_info(int bayerFormat, int pixelBitDepth)
{
    ...
    switch (bayerFormat) {
    case 0: // hololink::operators::ArgusIspOp::BayerFormat::BGGR
        phase = Argus::BAYER_PHASE_BGGR;
        break;
    ...
    case 2: // hololink::operators::ArgusIspOp::BayerFormat::GBRG
        ...
        break;
    case 3: // hololink::operators::ArgusIspOp::BayerFormat::RGGB
        phase = Argus::BAYER_PHASE_GRBG;
        break;
    default:
